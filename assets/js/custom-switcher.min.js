...
function switcherClick() {
    ...
    let rtlVar = rtlBtn.addEventListener('click', () => {
        localStorage.setItem('webino_language', 'fa');
        rtlFn();
    ...
    let ltrVar = ltrBtn.addEventListener('click', () => {
        //    local storage
        localStorage.setItem('webino_language', 'en');
        ltrFn();
        if (document.querySelector(".noUi-target")) {
            document.querySelectorAll(".noUi-origin").forEach((e) => {
...
function ltrFn() {
    ...
    if (styleLink && !styleLink.getAttribute('href').includes('bootstrap.min.css')) {
        const currentHref = styleLink.getAttribute('href') || '';
        const ltrHref = currentHref.includes('bootstrap.rtl.min.css')
            ? currentHref.replace('bootstrap.rtl.min.css', 'bootstrap.min.css')
            : "./assets/libs/bootstrap/css/bootstrap.min.css";
        styleLink.setAttribute("href", ltrHref);
    }
...
function checkOptions() {
    ...
    // RTL/LTR - Use webino_language system
    ...
    if (isRTL) {
        const rtlCheckbox = document.querySelector('#switcher-rtl');
        if (rtlCheckbox) rtlCheckbox.checked = true;
        if (html) {
            html.setAttribute("dir", "rtl");
            html.setAttribute("lang", "fa");
        }
        if (styleLink) {
            ...
            styleLink.setAttribute("href", rtlHref || "./assets/libs/bootstrap/css/bootstrap.rtl.min.css");
        }
    } else {
        const ltrCheckbox = document.querySelector('#switcher-ltr');
        if (ltrCheckbox) ltrCheckbox.checked = true;
        if (html) {
            html.setAttribute("dir", "ltr");
            html.setAttribute("lang", "en");
        }
        if (styleLink) {
            ...
            styleLink.setAttribute("href", ltrHref || "./assets/libs/bootstrap/css/bootstrap.min.css");
        }
    }else {
